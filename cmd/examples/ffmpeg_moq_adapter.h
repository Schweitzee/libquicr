...
class FfmpegToMoQAdapter
{
  public:
    ...
    void OnInit(int stream_index, const uint8_t* init, size_t init_len, bool last_init) const;

    void OnFrag(int stream_index, const uint8_t* whole_chunk, size_t whole_chunk_len, bool keyframe) const;
